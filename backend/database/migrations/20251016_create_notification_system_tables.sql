...
CREATE TABLE IF NOT EXISTS notification_messages (
    ...
    INDEX idx_deadline (deadline_at) WHERE deadline_at IS NOT NULL AND responded_at IS NULL,
...
CREATE TABLE IF NOT EXISTS notification_audit_log (
    ...
    user_agent TEXT,
    metadata JSONB,
    INDEX idx_group_audit (group_id, timestamp DESC),
    INDEX idx_message_audit (message_id, timestamp DESC)
);
...
CREATE TABLE IF NOT EXISTS compliance_violations (
    ...
    INDEX idx_violation_date (violation_date DESC)
);
...
CREATE TABLE IF NOT EXISTS cost_transactions (
    ...
    metadata JSONB,
    INDEX idx_company_date (company_id, transaction_date DESC),
    INDEX idx_employee_date (employee_id, transaction_date DESC)
);
...
CREATE TABLE IF NOT EXISTS proactive_executions (
    ...
    INDEX idx_rule_time (rule_id, execution_time DESC)
);
