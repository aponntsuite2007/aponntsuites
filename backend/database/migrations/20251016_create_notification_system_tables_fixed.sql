...
CREATE TABLE IF NOT EXISTS notification_groups (
    ...
    CREATE INDEX idx_created ON notification_groups (created_at DESC,
...
CREATE TABLE IF NOT EXISTS notification_messages (
    ...
    CREATE INDEX idx_deadline ON notification_messages (deadline_at) WHERE deadline_at IS NOT NULL AND responded_at IS NULL,
...
CREATE TABLE IF NOT EXISTS notification_audit_log (
    ...
    user_agent TEXT,
    metadata JSONB,
    CREATE INDEX idx_group_audit ON notification_groups (group_id, timestamp DESC,
    CREATE INDEX idx_message_audit ON notification_groups (message_id, timestamp DESC
);
...
CREATE TABLE IF NOT EXISTS company_modules (
    ...
    INDEX idx_company_modules (company_id, is_active)
);
...
CREATE TABLE IF NOT EXISTS business_validations (
    ...
    */
    ...
    active BOOLEAN DEFAULT true,
    INDEX idx_company_dept_validations (company_id, department_id)
);
...
CREATE TABLE IF NOT EXISTS compliance_violations (
    ...
    CREATE INDEX idx_violation_date ON notification_groups (violation_date DESC
);
...
CREATE TABLE IF NOT EXISTS notification_context_data (
    ...
    INDEX idx_message_context (notification_message_id)
);
...
CREATE TABLE IF NOT EXISTS cost_budgets (
    ...
    INDEX idx_company_period (company_id, period_start),
    INDEX idx_department_period (department_id, period_start)
);
...
CREATE TABLE IF NOT EXISTS cost_transactions (
    ...
    metadata JSONB,
    CREATE INDEX idx_company_date ON notification_groups (company_id, transaction_date DESC,
    CREATE INDEX idx_employee_date ON notification_groups (employee_id, transaction_date DESC
);
...
CREATE TABLE IF NOT EXISTS proactive_executions (
    ...
    CREATE INDEX idx_rule_time ON notification_groups (rule_id, execution_time DESC
);
...
CREATE TABLE IF NOT EXISTS approved_shift_swaps (
    ...
    INDEX idx_swap_date (company_id, swap_date),
    INDEX idx_employees (employee_1_id, employee_2_id, swap_date),
...
CREATE TABLE IF NOT EXISTS calendar_events (
    ...
    INDEX idx_employee_events (employee_id, event_start)
);
...
CREATE TABLE IF NOT EXISTS notification_escalations (
    ...
    INDEX idx_deadline (original_deadline)
);
...
CREATE TABLE IF NOT EXISTS audit_reports (
    ...
    CREATE INDEX idx_generated_at ON notification_groups (generated_at DESC,
...
CREATE TABLE IF NOT EXISTS report_access_log (
    ...
    ip_address INET,
    user_agent TEXT,
    CREATE INDEX idx_report_access ON notification_groups (report_id, accessed_at DESC,
    CREATE INDEX idx_access_type ON notification_groups (access_type, accessed_at DESC
);
