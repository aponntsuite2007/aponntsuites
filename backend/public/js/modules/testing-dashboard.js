/**
 * 🧪 TESTING DASHBOARD - Panel de Control de Testing Avanzado
 *
...
const TestingDashboard = {
   ...
   */
  async init() {
    console.log('🧪 [TESTING] Inicializando Testing Dashboard...');

    this.render();
    this.attachEventListeners();
    await this.loadTestHistory();

    console.log('✅ [TESTING] Dashboard inicializado');
  },
      ...
      <div class="testing-dashboard">
        ...
        <div class="dashboard-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 10px; margin-bottom: 30px;">
          ...
          <p style="margin: 0; opacity: 0.9;">
            Control de Testing Avanzado - E2E, Performance, Security
          </p>
        </div>
        ...
        tbody.innerHTML = data.history.map(test => `
          <tr style="border-bottom: 1px solid #e0e0e0;">
            ...
            <td style="padding: 15px;">
              <button onclick="TestingDashboard.viewTestDetails('${test.id}')" style="padding: 5px 15px; background: #2196F3; color: white; border: none; border-radius: 4px; cursor: pointer;">
                Ver Detalles
              </button>
            </td>
          </tr>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = TestingDashboard;
}
