  ...
  try {
    ...
    const attendances = await sequelize.query(`
      SELECT
        ...
        a.company_id,
        a."checkInMethod" as check_in_method,
        a."checkOutMethod" as check_out_method,
        a.check_in_latitude,
        ...
        COALESCE(a.shift_id, s.id) as shift_id,
    ...
    const processedAttendances = await Promise.all(attendances.map(async (att) => {
      ...
      return {
        ...
        minutes_late: att.minutes_late || lateInfo.minutesLate || 0,
        kioskId: att.kioskId,
        kiosk_id: att.kioskId,
        ...
        // Alias GPS para compatibilidad con tests
        gps_lat: att.check_in_latitude,
        gps_lng: att.check_in_longitude,
        // Horas trabajadas
