 ...
 *
 * Generado: 2026-02-05T01:03:03.962Z
 * Versión: 2.0.20260204-auto
 * Módulo: attendance
 *
 * ESTADÍSTICAS:
 * - Total stages: 152
...
class AttendanceWorkflowGenerated {
    ...
    static STAGES = {
        ...
        GET_USER_CONTEXT: {
            ...
            validations: ["user","user.isActive && !user.is_active","department"],
            transitions_to: ["FAILED"],
            isAutoGenerated: true,
        },
    ...
    static WORKFLOW_METADATA = {
        ...
        module: 'attendance',
        version: '2.0.20260204-auto',
        isAutoGenerated: true,
        generatedAt: '2026-02-05T01:03:03.962Z',
