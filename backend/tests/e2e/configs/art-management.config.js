/**
 * CONFIGURACIÓN E2E - GESTIÓN DE ART
...
module.exports = {
  ...
  moduleName: 'Gestión de ART',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.art-providers-list',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM art-management WHERE id = $1', [id]);
    }
  },
