/**
 * CONFIGURACIÓN E2E - ASOCIADOS APONNT
...
module.exports = {
  ...
  moduleKey: 'associate-marketplace',
  moduleName: 'Asociados APONNT',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.marketplace-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM associate-marketplace WHERE id = $1', [id]);
    }
  },
