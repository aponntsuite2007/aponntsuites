/**
 * CONFIGURACIÓN E2E - PANEL DE WORKFLOW DE ASOCIADOS
...
module.exports = {
  ...
  database: {
    table: 'associate-workflow-panel',
    primaryKey: 'id',
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM associate-workflow-panel WHERE id = $1', [id]);
    }
  },
