...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM benefits-management WHERE id = $1', [id]);
    }
  },
