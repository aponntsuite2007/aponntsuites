/**
 * CONFIGURACIÓN E2E - CONSENTIMIENTOS Y PRIVACIDAD
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'biometric-consent',
  moduleName: 'Consentimientos y Privacidad',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.bc-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM biometric-consent WHERE id = $1', [id]);
    }
  },
