...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM company-account WHERE id = $1', [id]);
    }
  },
