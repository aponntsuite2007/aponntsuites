/**
 * CONFIGURACIÓN E2E - ASIGNACIÓN DE EMAILS A PROCESOS
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'company-email-process',
  moduleName: 'Asignación de Emails a Procesos',
  category: 'admin',
  baseUrl: 'http://localhost:9998/panel-administrativo.html',

  navigation: {
    listContainerSelector: '.process-list',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM company-email-process WHERE id = $1', [id]);
    }
  },
