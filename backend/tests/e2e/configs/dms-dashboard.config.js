/**
 * CONFIGURACIÓN E2E - GESTIÓN DOCUMENTAL (DMS)
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'dms-dashboard',
  moduleName: 'Gestión Documental (DMS)',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '#dms-dashboardContainer, #mainContent',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM dms-dashboard WHERE id = $1', [id]);
    }
  },
