/**
 * CONFIGURACIÓN E2E - ANÁLISIS EMOCIONAL
...
module.exports = {
  ...
  moduleKey: 'emotional-analysis',
  moduleName: 'Análisis Emocional',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.emotional-analysis-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM emotional-analysis WHERE id = $1', [id]);
    }
  },
