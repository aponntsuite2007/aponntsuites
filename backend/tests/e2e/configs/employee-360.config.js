/**
 * CONFIGURACIÓN E2E - EXPEDIENTE 360°
...
module.exports = {
  ...
  moduleKey: 'employee-360',
  moduleName: 'Expediente 360°',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.e360-comparison-list',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM employee-360 WHERE id = $1', [id]);
    }
  },
