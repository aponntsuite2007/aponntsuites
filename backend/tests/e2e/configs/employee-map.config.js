/**
 * CONFIGURACIÓN E2E - MAPA DE EMPLEADOS
...
module.exports = {
  ...
  moduleName: 'Mapa de Empleados',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.em-map-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM employee-map WHERE id = $1', [id]);
    }
  },
