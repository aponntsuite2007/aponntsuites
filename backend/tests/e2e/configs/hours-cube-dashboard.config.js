/**
 * CONFIGURACIÓN E2E - PANEL EJECUTIVO DE HORAS
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'hours-cube-dashboard',
  moduleName: 'Panel Ejecutivo de Horas',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.hcd-chart-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM hours-cube-dashboard WHERE id = $1', [id]);
    }
  },
