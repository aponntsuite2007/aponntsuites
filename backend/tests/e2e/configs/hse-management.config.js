/**
 * CONFIGURACIÓN E2E - SEGURIDAD E HIGIENE LABORAL (HSE)
...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM hse-management WHERE id = $1', [id]);
    }
  },
