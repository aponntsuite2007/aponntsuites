/**
 * CONFIGURACIÓN E2E - BANDEJA NOTIFICACIONES
...
module.exports = {
  moduleKey: 'inbox',
  moduleName: 'Bandeja Notificaciones',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.inbox-list',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM inbox WHERE id = $1', [id]);
    }
  },
