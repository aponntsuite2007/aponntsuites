/**
 * CONFIGURACIÓN E2E - BÚSQUEDAS LABORALES
...
module.exports = {
  ...
  moduleName: 'Búsquedas Laborales',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.talent-container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM job-postings WHERE id = $1', [id]);
    }
  },
