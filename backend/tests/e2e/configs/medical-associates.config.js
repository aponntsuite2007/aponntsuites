/**
 * CONFIGURACIÓN E2E - MEDICAL ASSOCIATES
 * 🚨 DELEGADO - Sub-módulo de medical - Integrado en parent
 *
...
module.exports = {
  ...
  moduleName: 'Medical Associates',
  category: 'delegated-backend-only',
  isDelegated: true,
  delegationReason: 'Sub-módulo de medical - Integrado en parent',
