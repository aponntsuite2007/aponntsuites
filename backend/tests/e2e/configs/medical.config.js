/**
 * CONFIGURACIÓN E2E - MEDICAL
 * 🚨 DELEGADO - Panel médico separado - Ver medical-dashboard-professional.js
 *
...
module.exports = {
  ...
  isDelegated: true,
  delegationReason: 'Panel médico separado - Ver medical-dashboard-professional.js',
