/**
 * CONFIGURACIÓN E2E - CENTRO DE NOTIFICACIONES
...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM notification-center WHERE id = $1', [id]);
    }
  },
