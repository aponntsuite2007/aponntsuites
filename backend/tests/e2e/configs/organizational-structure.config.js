/**
 * CONFIGURACIÓN E2E - ESTRUCTURA ORGANIZACIONAL
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'organizational-structure',
  moduleName: 'Estructura Organizacional',
  category: 'empresa',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM organizational-structure WHERE id = $1', [id]);
    }
  },
