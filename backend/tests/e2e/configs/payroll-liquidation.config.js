/**
 * CONFIGURACIÓN E2E - LIQUIDACIÓN DE SUELDOS
...
module.exports = {
  ...
  moduleName: 'Liquidación de Sueldos',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.ph-tips-list',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM payroll-liquidation WHERE id = $1', [id]);
    }
  },
