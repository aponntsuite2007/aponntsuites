/**
 * CONFIGURACIÓN E2E - MANAGER DE PHASE4
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'phase4-integrated-manager',
  moduleName: 'Manager de Phase4',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '#phase4-integrated-managerContainer, #mainContent',
  ...
  database: {
    table: 'phase4-integrated-manager',
    primaryKey: 'id',
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM phase4-integrated-manager WHERE id = $1', [id]);
    }
  },
