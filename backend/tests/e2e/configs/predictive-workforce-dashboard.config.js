/**
 * CONFIGURACIÓN E2E - DASHBOARD PREDICTIVO DE WORKFORCE
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'predictive-workforce-dashboard',
  moduleName: 'Dashboard Predictivo de Workforce',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.predictive-workforce-container',
  ...
  database: {
    table: 'predictive-workforce-dashboard',
    primaryKey: 'id',
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM predictive-workforce-dashboard WHERE id = $1', [id]);
    }
  },
