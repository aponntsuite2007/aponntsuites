...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM procedures-manual WHERE id = $1', [id]);
    }
  },
