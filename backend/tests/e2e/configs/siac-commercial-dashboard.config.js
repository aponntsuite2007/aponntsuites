/**
 * CONFIGURACIÓN E2E - SIAC COMERCIAL INTEGRAL
 * ⭐ AUTO-GENERADO por inspector de frontend
 * Sistema SYNAPSE - Selectores REALES extraídos del código
 */

module.exports = {
  moduleKey: 'siac-commercial-dashboard',
  moduleName: 'SIAC Comercial Integral',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.siac-alerts-list',
  ...
  database: {
    table: 'siac-commercial-dashboard',
    primaryKey: 'id',
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM siac-commercial-dashboard WHERE id = $1', [id]);
    }
  },
