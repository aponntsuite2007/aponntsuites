...
module.exports = {
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM sla-tracking WHERE id = $1', [id]);
    }
  },
