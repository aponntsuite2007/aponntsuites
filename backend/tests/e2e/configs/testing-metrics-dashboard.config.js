/**
 * CONFIGURACIÓN E2E - TESTING METRICS DASHBOARD
 * 🚨 DELEGADO - Integrado en engineering-dashboard
 *
...
module.exports = {
  ...
  moduleName: 'Testing Metrics Dashboard',
  category: 'delegated-backend-only',
  isDelegated: true,
  delegationReason: 'Integrado en engineering-dashboard',
