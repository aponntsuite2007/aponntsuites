/**
 * CONFIGURACIÓN E2E - GESTIÓN DE CAPACITACIONES
...
module.exports = {
  ...
  moduleName: 'Gestión de Capacitaciones',
  category: 'empresa',
  baseUrl: 'http://localhost:9998/panel-empresa.html',

  navigation: {
    listContainerSelector: '.container',
  ...
  database: {
    ...
    testDataCleanup: async (db, id) => {
      // await db.query('DELETE FROM training-management WHERE id = $1', [id]);
    }
  },
