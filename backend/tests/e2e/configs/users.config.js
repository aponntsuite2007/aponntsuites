/**
 * CONFIGURACIÓN E2E - GESTIÓN DE USUARIOS
...
module.exports = {
  ...
  navigation: {
    listContainerSelector: '.users-table-container',
    createButtonSelector: '.btn-add',
    openModalSelector: 'button[data-action="open"], .btn-add',
